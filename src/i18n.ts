...
export const i18n: Record<Language, i18nSchema> = {
  eng: {
    ...
    loadingStages: [
      ...
      { title: "INVOKING PULSE AI ANALYTICAL LAYER", detail: "Synthesizing diagnostics, compiling optimal remedies..." },
    ...
    customDiagDesc: "Action tasks synthesized by Pulse AI to optimize performance. Click each row to toggle senior-level remedies.",
    all: "all",
  ...
  uzb: {
    ...
    heroTitle: "Sayt holatini tekshiring. Eng mukammal yechimlar.",
    heroDesc: "Dasturchilar qulayligi uchun yaratilgan ilg'or sayt unumdorligi tahlilchisi. Istalgan URL manzilini kiriting hamda real vaqtda ishlash tezligi ko'rsatkichlari, Core Web Vitals unumdorligi va nusxalash mumkin bo'lgan aqlli AI tahliliy tavsiyalariga ega bo'ling.",
    placeholder: "apple.com/iphone-15-pro",
    ...
    loadingStages: [
      ...
      { title: "PULSE AI ANALYSIS MODELINI ISHGA TUSHIRISH", detail: "Keng qamrovli neyrotarmoq yordamida yechimlar tayyorlash..." },
  ...
  rus: {
    ...
    heroDesc: "Передовой анализатор производительности сайтов, разработанный специально для программистов. Введите рабочий URL-адрес, чтобы получить детальный отчет Core Web Vitals вместе с готовым к копированию кодом от Pulse AI.",
    placeholder: "apple.com/iphone-15-pro",
    ...
    loadingStages: [
      ...
      { title: "АКТИВАЦИЯ АНАЛИТИЧЕСКИХ МОДЕЛЕЙ PULSE AI", detail: "Интеллектуальный синтез диагностических решений и кода..." },
